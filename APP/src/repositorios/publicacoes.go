...
// BuscarPorID tras uma unica publicacao do banco de dados
...
// Buscar tras as publicacoes dos usuarios seguidos e também do proprio usuario que fez a req
...
// Atualizar altera os dados de um publicacao no banco de dados
